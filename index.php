...
<div class="container">
	...
	<div class="row contentlogin">
        ...
        <div class="col-xs-12 col-sm-8 col-md-5 col-sm-offset-3 col-md-offset-3 text-center">
            <h2 class="logintitle">Sign Up Now</h2>
        </div>
	    <div class="col-xs-12 col-sm-8 col-md-5 col-sm-offset-3 col-md-offset-3 loginpage">
			<form role="form" method="post" action="" autocomplete="off">
				...
				if(isset($_GET['action']) && $_GET['action'] == 'joined'){
					echo "<p class='alert alert-success'>Registration successful, please check your email to activate your account.</p>";
				}
				?>
				...
				<div class="row">
					<div class="col-xs-12 col-md-12">
					    <input type="submit" name="submit" value="Sign Up" class="btn btn-primary btn-block btn-lg" tabindex="5"></div>
				</div>
				
				<div class="row">
					<div class="col-xs-12 col-md-12">
					    <p>Do you already have an account?<a href="login.php" class="sign-holder__link"> Login</a></p>
					    </div>
				</div>
			</form>
		</div>
