(function ( $ ) {
            ...
            if (gMapContext.settings.enableReverseGeocode) {
                gMapContext.geodecoder.geocode({latLng: gMapContext.location}, function(results, status){
                    if (status == google.maps.GeocoderStatus.OK && results.length > 0){
                        ...
                        gMapContext.name = results[0].name;
    ...
    function updateInputLatLngValues(inputBinding, gmapContext,place){

        console.log("updateInputLatLngValues");
        console.log(gmapContext);
        //console.log(inputBinding);
        ...
        if (inputBinding.locationNameInput) {
            ...
            inputBinding.locationNameInput.val(place.name+', '+place.formatted_address);//.change();
            ...
            if (inputBinding.locationNameInput && gmapContext.settings.enableAutocomplete) {
                ...
                google.maps.event.addListener(gmapContext.autocomplete, 'place_changed', function() {
                    ...
                    GmUtility.setPosition(gmapContext, place.geometry.location, function(context) {
                        updateInputLatLngValues(inputBinding, context,place);
                        context.settings.onchanged.apply(gmapContext.domContainer,
                            [GmUtility.locationFromLatLng(context.location), context.radius, false]);
                    });
                });
    ...
    $.fn.locationpicker.defaults = {
        ...
        oninitialized: function (component) {}
            ...
            jQuery(function($){
                console.log("mask");
               $("#shipping_zipcode_input").mask("99999",{autoclear:false,placeholder:"#####"});
            });
            ...
            /*$( "#editAddressModal" ).on('shown.bs.modal', function(){
                ...
                $('#us2').locationpicker({
                    location: {
                        latitude: $('input[name="edit_latitude"]').val(),
                        longitude: $('input[name="edit_longitude"]').val()
                    },  
                    radius: 0,
                    inputBinding: {
                        latitudeInput: $('input[name="edit_latitude"]'),
                        longitudeInput: $('input[name="edit_longitude"]'),
